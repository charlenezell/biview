...
/***** module 0 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"container\">\n    <button type=\"default\" @click=\"showAddCountDown($event)\">新建计时器</button>\n    <div class=\"clockList\" v-if=\"(countDownList.length>0)\">\n      <div class=\"clockItem\" v-for=\"(index, item) in (countDownList)\" :wx:key=\"(item.id)\">\n          <div class=\"clockItem__rm\" @click=\"clockRemoveHaneler((item.id),$event)\">X</div>\n          <div class=\"clockItem__h\">{{item.name}}</div>\n          <div class=\"clockItem__t\">{{item.time}}</div>\n          <div class=\"clockItem__t2\">{{item.leaveTimeString}}</div>\n          <div class=\"clockItem__c\">\n            <button @click=\"clockHandler((item.id),(item.status),$event)\" size=\"mini\" :type=\"(item.status==0?'primary':'warn')\">{{item.status==0?'开始':'暂停'}}</button>\n            <button @click=\"clockResetHandler((item.id),$event)\" type=\"default\" size=\"mini\">重设</button>\n          </div>\n      </div>\n    </div>\n    <div class=\"addCountDownForm\" v-if=\"(addCountDownFormShow)\">\n      <div class=\"weui-cells\">\n          <!-- <view class=\"weui-cell\">\n              <view class=\"weui-cell__hd\">\n                  <view class=\"weui-label\">使用预设时钟</view>\n              </view>\n              <view class=\"weui-cell__bd\">\n                  <switch bindchange=\"customCountHandler\"/>\n              </view>\n          </view> -->\n          <div class=\"weui-cell\">\n              <div class=\"weui-cell__hd\">\n                  <div class=\"weui-label\">计时器名字</div>\n              </div>\n              <div class=\"weui-cell__bd\">\n                  <input class=\"weui-input\" placeholder=\"请输倒计时名字\" @keyup=\"inputChange($event)\" :value=\"(countDownName)\"/>\n              </div>\n          </div>\n          <div class=\"weui-cell\">\n              <div class=\"weui-cell__hd\">\n                  <div class=\"weui-label\">倒计时</div>\n              </div>\n              <div class=\"weui-cell__bd\">\n                  <picker mode=\"time\" start=\"00:00\" end=\"60:00\" @change=\"bindTimeChange($event)\" :value=\"(countDownValue)\">\n                    <input class=\"weui-input\" readonly=\"readonly\" :value=\"(countDownValue)\"/>\n                  </picker>\n              </div>\n          </div>\n          <div class=\"weui-cell\">\n            <div class=\"presetList\">\n              <div @click=\"presetItemClick((item.time),(index),(item.name),$event)\" v-for=\"(index, item) in (presets)\" :class=\"'presetItem ' + (selectedCustom===index?'presetItem--on':'')\" :wx:key=\"(item.id)\">\n                <div class=\"presetItem__h\">{{item.name}}</div>\n                <div class=\"presetItem__t\">{{item.time}}</div>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"weui-btn-area\">\n          <button @click=\"sureAddCountDown($event)\" type=\"primary\" :loading=\"(false)\" :plain=\"(false)\" :disabled=\"(false)\">确定</button>\n        </div>\n        <div class=\"weui-btn-area\">\n          <button type=\"default\" @click=\"cancelAddCountDown($event)\" hover-class=\"other-button-hover\" :plain=\"(false)\" :disabled=\"(false)\">取消</button>\n        </div>\n    </div>\n  </div>\n"},/***** module 0 end *****/
...
__wepy_require(2).default.$createApp(_default, {"routes":{"pages/index":7},"style":[6,124],"components":{},"apis":{}});
...
var _countDown = __wepy_require(8);
...
function stringToTime(time) {
  var _time$split = time.split(':'),
      ...
      minute = _time$split2[0],
      second = _time$split2[1];
...
var Index = (_dec = (0, _wepyRedux.connect)({
  countDownList: function countDownList(state) {
  ...
  addCountDown: _countDown.ADD_COUNTDOWN,
  updateCountDown: _countDown.UPDATE_COUNTDOWN,
  startCountDown: _countDown.START_COUNTDOWN,
  stopCountDown: _countDown.STOP_COUNTDOWN,
  removeCountDown: _countDown.REMOVE_COUNTDOWN,
  resetCountDown: _countDown.RESET_COUNTDOWN
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      presetItemClick: function presetItemClick(time, index, name) {
      ...
      showAddCountDown: function showAddCountDown() {
        this.addCountDownFormShow = true;
      },
      cancelAddCountDown: function cancelAddCountDown() {
        reset.call(this);
      },
      sureAddCountDown: function sureAddCountDown() {
      ...
      clockRemoveHaneler: function clockRemoveHaneler(id) {
        this.methods.removeCountDown(id);
      },
      clockResetHandler: function clockResetHandler(id) {
        this.methods.resetCountDown(id);
      },
      clockHandler: function clockHandler(id, status) {
        if (status == 0) {
          ...
          if (v.status == 1 && !v.stop) {
            ...
            if (ltime > 0) {
              ...
              if (lt <= 0) {
                ...
                console.log(v.leaveTime, v.name + '\u5012\u8BA1\u65F6' + v.time + '\u5DF2\u7ECF\u5230\u65F6\u95F4\u4E86\uFF01\uFF01');
                updateCountDown({
                  id: v.id,
                  data: {
                    leaveTime: 0,
  ...
  _createClass(Index, [{
    ...
    value: function onLoad() {
      ...
      this.___timer = setInterval(function () {
        _this2.methods.updateList(_this2.countDownList, _this2.methods);
      }, 30);
    }
  }, {
    key: 'onUnload',
...
/***** module 8 start *****/
/***** src\store\types\countDown.js *****/
function(module, exports, __wepy_require) {'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var ADD_COUNTDOWN = exports.ADD_COUNTDOWN = 'ADD_COUNTDOWN';
var REMOVE_COUNTDOWN = exports.REMOVE_COUNTDOWN = 'REMOVE_COUNTDOWN';
var UPDATE_COUNTDOWN = exports.UPDATE_COUNTDOWN = 'UPDATE_COUNTDOWN';
var RESET_COUNTDOWN = exports.RESET_COUNTDOWN = 'RESET_COUNTDOWN';
var START_COUNTDOWN = exports.START_COUNTDOWN = 'START_COUNTDOWN';
var STOP_COUNTDOWN = exports.STOP_COUNTDOWN = 'STOP_COUNTDOWN';
},/***** module 8 end *****/
...
var _countDown = __wepy_require(40);
...
/***** module 40 start *****/
/***** src\store\reducers\countDown.js *****/
function(module, exports, __wepy_require) {'use strict';
...
var genId = 0;
exports.default = (0, _reduxActions.handleActions)((_handleActions = {}, _defineProperty(_handleActions, _countDown.ADD_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: [].concat(_toConsumableArray(state.countDownList), [_extends({}, action.payload, {
      id: genId++,
      status: 0
    })])
  });
}), _defineProperty(_handleActions, _countDown.REMOVE_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: state.countDownList.filter(function (v) {
      return v.id !== action.payload;
    })
  });
}), _defineProperty(_handleActions, _countDown.RESET_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: state.countDownList.map(function (v) {
...
}), _defineProperty(_handleActions, _countDown.UPDATE_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: state.countDownList.map(function (v) {
      if (v.id == action.payload.id) {
        return _extends({}, v, action.payload.data);
      } else {
        return v;
      }
    })
  });
}), _defineProperty(_handleActions, _countDown.STOP_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: state.countDownList.map(function (v) {
      if (v.id == action.payload) {
        return _extends({}, v, {
...
}), _defineProperty(_handleActions, _countDown.START_COUNTDOWN, function (state, action) {
  return _extends({}, state, {
    countDownList: state.countDownList.map(function (v) {
      if (v.id == action.payload) {
        return _extends({}, v, {
...
function(module, exports, __wepy_require) {var baseGetTag = __wepy_require(45),
    getPrototype = __wepy_require(46),
    isObjectLike = __wepy_require(47);
...
var _ponyfill = __wepy_require(48);
 ...
 */
var baseFor = __wepy_require(49),
    isArguments = __wepy_require(50),
    keysIn = __wepy_require(51);
...
var _createAction = __wepy_require(52);

var _createAction2 = _interopRequireDefault(_createAction);

var _handleAction = __wepy_require(53);

var _handleAction2 = _interopRequireDefault(_handleAction);

var _handleActions = __wepy_require(54);

var _handleActions2 = _interopRequireDefault(_handleActions);

var _combineActions = __wepy_require(55);

var _combineActions2 = _interopRequireDefault(_combineActions);

var _createActions = __wepy_require(56);
...
function(module, exports, __wepy_require) {var Symbol = __wepy_require(57),
    getRawTag = __wepy_require(58),
    objectToString = __wepy_require(59);
...
function(module, exports, __wepy_require) {var overArg = __wepy_require(60);
 ...
 * Available under MIT license <https://lodash.com/license>
 */
var isArguments = __wepy_require(50),
    isArray = __wepy_require(61);
...
var _identity = __wepy_require(62);

var _identity2 = _interopRequireDefault(_identity);

var _isFunction = __wepy_require(63);

var _isFunction2 = _interopRequireDefault(_isFunction);

var _isNull = __wepy_require(64);

var _isNull2 = _interopRequireDefault(_isNull);

var _invariant = __wepy_require(65);
...
var _isNil = __wepy_require(66);

var _isNil2 = _interopRequireDefault(_isNil);

var _isUndefined = __wepy_require(67);

var _isUndefined2 = _interopRequireDefault(_isUndefined);

var _includes = __wepy_require(68);
...
var _reduceReducers = __wepy_require(69);
...
var _ownKeys = __wepy_require(70);

var _ownKeys2 = _interopRequireDefault(_ownKeys);

var _flattenUtils = __wepy_require(71);
...
var _isString = __wepy_require(72);
...
var _isEmpty = __wepy_require(73);

var _isEmpty2 = _interopRequireDefault(_isEmpty);

var _toString = __wepy_require(74);

var _toString2 = _interopRequireDefault(_toString);

var _isSymbol = __wepy_require(75);
...
var _camelCase = __wepy_require(76);
...
var _isArray = __wepy_require(77);

var _isArray2 = _interopRequireDefault(_isArray);

var _last = __wepy_require(78);
...
var _arrayToObject = __wepy_require(79);
...
function(module, exports, __wepy_require) {var root = __wepy_require(80);
...
function(module, exports, __wepy_require) {var baseIndexOf = __wepy_require(82),
    isArrayLike = __wepy_require(83),
    isString = __wepy_require(72),
    toInteger = __wepy_require(84),
    values = __wepy_require(85);
...
/***** module 71 start *****/
/***** node_modules\redux-actions\lib\flattenUtils.js *****/
function(module, exports, __wepy_require) {'use strict';
...
var _hasGeneratorInterface = __wepy_require(86);
...
function(module, exports, __wepy_require) {var baseKeys = __wepy_require(87),
    getTag = __wepy_require(88),
    isArguments = __wepy_require(89),
    isArray = __wepy_require(77),
    isArrayLike = __wepy_require(83),
    isBuffer = __wepy_require(90),
    isPrototype = __wepy_require(91),
    isTypedArray = __wepy_require(92);
...
function(module, exports, __wepy_require) {var baseToString = __wepy_require(93);
...
/***** module 76 start *****/
/***** node_modules\redux-actions\lib\camelCase.js *****/
function(module, exports, __wepy_require) {'use strict';
...
/***** module 79 start *****/
/***** node_modules\redux-actions\lib\arrayToObject.js *****/
function(module, exports, __wepy_require) {"use strict";
...
function(module, exports, __wepy_require) {var freeGlobal = __wepy_require(94);
...
function(module, exports, __wepy_require) {var baseFindIndex = __wepy_require(95),
    baseIsNaN = __wepy_require(96),
    strictIndexOf = __wepy_require(97);
...
function(module, exports, __wepy_require) {var isFunction = __wepy_require(63),
    isLength = __wepy_require(98);
...
function(module, exports, __wepy_require) {var toFinite = __wepy_require(99);
...
function(module, exports, __wepy_require) {var baseValues = __wepy_require(100),
    keys = __wepy_require(101);
...
/***** module 86 start *****/
/***** node_modules\redux-actions\lib\hasGeneratorInterface.js *****/
function(module, exports, __wepy_require) {'use strict';
...
function(module, exports, __wepy_require) {var isPrototype = __wepy_require(91),
    nativeKeys = __wepy_require(102);
...
function(module, exports, __wepy_require) {var DataView = __wepy_require(103),
    Map = __wepy_require(104),
    Promise = __wepy_require(105),
    Set = __wepy_require(106),
    WeakMap = __wepy_require(107),
    baseGetTag = __wepy_require(45),
    toSource = __wepy_require(108);
...
function(module, exports, __wepy_require) {var baseIsArguments = __wepy_require(109),
    isObjectLike = __wepy_require(47);
...
function(module, exports, __wepy_require) {var baseIsTypedArray = __wepy_require(111),
    baseUnary = __wepy_require(112),
    nodeUtil = __wepy_require(113);
...
function(module, exports, __wepy_require) {var Symbol = __wepy_require(57),
    arrayMap = __wepy_require(114),
    isArray = __wepy_require(77),
    isSymbol = __wepy_require(75);
...
function(module, exports, __wepy_require) {/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER = 9007199254740991;
...
function(module, exports, __wepy_require) {var toNumber = __wepy_require(115);
...
function(module, exports, __wepy_require) {var arrayMap = __wepy_require(114);
...
function(module, exports, __wepy_require) {var arrayLikeKeys = __wepy_require(116),
    baseKeys = __wepy_require(87),
    isArrayLike = __wepy_require(83);
...
function(module, exports, __wepy_require) {var getNative = __wepy_require(117),
    root = __wepy_require(80);
...
function(module, exports, __wepy_require) {var isObject = __wepy_require(81),
    isSymbol = __wepy_require(75);
...
function(module, exports, __wepy_require) {var baseTimes = __wepy_require(118),
    isArguments = __wepy_require(89),
    isArray = __wepy_require(77),
    isBuffer = __wepy_require(90),
    isIndex = __wepy_require(119),
    isTypedArray = __wepy_require(92);
...
function(module, exports, __wepy_require) {var baseIsNative = __wepy_require(120),
    getValue = __wepy_require(121);
...
function(module, exports, __wepy_require) {var coreJsData = __wepy_require(123);
